...
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000170, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GCNL_Enemy_Frozen_C_OnActive, CallFunc_GetGameTimeInSeconds_ReturnValue) == 0x000188, "Member 'GCNL_Enemy_Frozen_C_OnActive::CallFunc_GetGameTimeInSeconds_ReturnValue' has a wrong offset!");
