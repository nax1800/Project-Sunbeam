...
class UTT_Ninja_Assassination_C final : public UFortGameplayAbilityTooltip
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"TT_Ninja_Assassination_C">();
	}
	static class UTT_Ninja_Assassination_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UTT_Ninja_Assassination_C>();
	}
};
static_assert(alignof(UTT_Ninja_Assassination_C) == 0x000008, "Wrong alignment on UTT_Ninja_Assassination_C");
static_assert(sizeof(UTT_Ninja_Assassination_C) == 0x000118, "Wrong size on UTT_Ninja_Assassination_C");
