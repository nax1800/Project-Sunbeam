...
static_assert(sizeof(StatsListItemWIdget_C_UpdateColors) == 0x0001A8, "Wrong size on StatsListItemWIdget_C_UpdateColors");
...
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, Temp_byte_Variable) == 0x000110, "Member 'StatsListItemWIdget_C_UpdateColors::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, Temp_byte_Variable2) == 0x000111, "Member 'StatsListItemWIdget_C_UpdateColors::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, CallFunc_Get_Base___Buff_Colors_Base) == 0x000114, "Member 'StatsListItemWIdget_C_UpdateColors::CallFunc_Get_Base___Buff_Colors_Base' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, CallFunc_Get_Base___Buff_Colors_Buff) == 0x000124, "Member 'StatsListItemWIdget_C_UpdateColors::CallFunc_Get_Base___Buff_Colors_Buff' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, Temp_class_Variable3) == 0x000138, "Member 'StatsListItemWIdget_C_UpdateColors::Temp_class_Variable3' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, K2Node_SwitchEnum_CmpSuccess) == 0x000140, "Member 'StatsListItemWIdget_C_UpdateColors::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, Temp_class_Variable4) == 0x000148, "Member 'StatsListItemWIdget_C_UpdateColors::Temp_class_Variable4' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, CallFunc_NotEqual_TextText_ReturnValue) == 0x000150, "Member 'StatsListItemWIdget_C_UpdateColors::CallFunc_NotEqual_TextText_ReturnValue' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, Temp_byte_Variable3) == 0x000151, "Member 'StatsListItemWIdget_C_UpdateColors::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, K2Node_Select_Default) == 0x000158, "Member 'StatsListItemWIdget_C_UpdateColors::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, K2Node_MakeStruct_SlateColor) == 0x000170, "Member 'StatsListItemWIdget_C_UpdateColors::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(StatsListItemWIdget_C_UpdateColors, K2Node_Select3_Default) == 0x000198, "Member 'StatsListItemWIdget_C_UpdateColors::K2Node_Select3_Default' has a wrong offset!");
