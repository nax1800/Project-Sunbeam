...
static_assert(sizeof(UCollectionBookSectionRewardWidget_C) == 0x0002C8, "Wrong size on UCollectionBookSectionRewardWidget_C");
...
static_assert(offsetof(UCollectionBookSectionRewardWidget_C, TextRewardName) == 0x0002C0, "Member 'UCollectionBookSectionRewardWidget_C::TextRewardName' has a wrong offset!");
