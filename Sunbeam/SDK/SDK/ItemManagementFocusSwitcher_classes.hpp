...
static_assert(sizeof(UItemManagementFocusSwitcher_C) == 0x000260, "Wrong size on UItemManagementFocusSwitcher_C");
...
static_assert(offsetof(UItemManagementFocusSwitcher_C, TileViewBIndex) == 0x000258, "Member 'UItemManagementFocusSwitcher_C::TileViewBIndex' has a wrong offset!");
