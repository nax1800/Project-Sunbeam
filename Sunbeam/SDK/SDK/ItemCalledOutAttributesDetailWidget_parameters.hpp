...
public:
	...
	class UStatsListItemWIdget_C*                 CallFunc_Array_Get_Item;                           // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FFortDisplayAttribute>          CallFunc_GetDisplayAttributesToCallOut_Attributes; // 0x0048(0x0010)(ZeroConstructor, ReferenceParm)
	class UStatsListItemWIdget_C*                 CallFunc_Create_ReturnValue;                       // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FFortDisplayAttribute                  CallFunc_Array_Get_Item2;                          // 0x0060(0x0070)()
	class UWrapBoxSlot*                           CallFunc_AddChildWrapBox_ReturnValue;              // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ItemCalledOutAttributesDetailWidget_C_UpdateStats) == 0x0000E8, "Wrong size on ItemCalledOutAttributesDetailWidget_C_UpdateStats");
...
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, K2Node_MakeStruct_Margin) == 0x000014, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_IsValid_ReturnValue) == 0x000024, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Length_ReturnValue) == 0x000028, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Less_IntInt_ReturnValue) == 0x000030, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Get_Item) == 0x000038, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_GetOwningPlayer_ReturnValue) == 0x000040, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_GetDisplayAttributesToCallOut_Attributes) == 0x000048, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_GetDisplayAttributesToCallOut_Attributes' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Create_ReturnValue) == 0x000058, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Get_Item2) == 0x000060, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_AddChildWrapBox_ReturnValue) == 0x0000D0, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_AddChildWrapBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Add_ReturnValue) == 0x0000D8, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Array_Length_ReturnValue2) == 0x0000DC, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Array_Length_ReturnValue2' has a wrong offset!");
static_assert(offsetof(ItemCalledOutAttributesDetailWidget_C_UpdateStats, CallFunc_Less_IntInt_ReturnValue2) == 0x0000E0, "Member 'ItemCalledOutAttributesDetailWidget_C_UpdateStats::CallFunc_Less_IntInt_ReturnValue2' has a wrong offset!");
