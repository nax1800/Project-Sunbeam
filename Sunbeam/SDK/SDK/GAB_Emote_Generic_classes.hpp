...
static_assert(sizeof(UGAB_Emote_Generic_C) == 0x000A48, "Wrong size on UGAB_Emote_Generic_C");
static_assert(offsetof(UGAB_Emote_Generic_C, UberGraphFrame) == 0x000A40, "Member 'UGAB_Emote_Generic_C::UberGraphFrame' has a wrong offset!");
