...
static_assert(sizeof(ATheaterMapViewer_C) == 0x000698, "Wrong size on ATheaterMapViewer_C");
static_assert(offsetof(ATheaterMapViewer_C, DefaultSceneRoot) == 0x000690, "Member 'ATheaterMapViewer_C::DefaultSceneRoot' has a wrong offset!");
