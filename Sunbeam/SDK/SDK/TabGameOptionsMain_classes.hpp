...
public:
	...
	class UOptionsMenuSlider_C*                   GamepadScopedMultiplier;                           // 0x02E0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   GamepadTargetingMultiplier;                        // 0x02E8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     InvertMouse;                                       // 0x02F0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     Language;                                          // 0x02F8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   MouseScopedMultiplier;                             // 0x0300(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   MouseSensitivity;                                  // 0x0308(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   MouseTargetingMultiplier;                          // 0x0310(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     Region;                                            // 0x0318(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UOptionsMenuSlider_C*                   SafeZone;                                          // 0x0320(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     ShowBackpack;                                      // 0x0328(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     ShowHeadAccessories;                               // 0x0330(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     SprintCancelsReload;                               // 0x0338(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     TapInteract;                                       // 0x0340(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     ToggleSprint;                                      // 0x0348(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class URotatorSelector_C*                     ToggleTargeting;                                   // 0x0350(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                       TooltipDisplayReference;                           // 0x0358(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UTabGameOptionsMain_C) == 0x000360, "Wrong size on UTabGameOptionsMain_C");
...
static_assert(offsetof(UTabGameOptionsMain_C, GamepadScopedMultiplier) == 0x0002E0, "Member 'UTabGameOptionsMain_C::GamepadScopedMultiplier' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, GamepadTargetingMultiplier) == 0x0002E8, "Member 'UTabGameOptionsMain_C::GamepadTargetingMultiplier' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, InvertMouse) == 0x0002F0, "Member 'UTabGameOptionsMain_C::InvertMouse' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, Language) == 0x0002F8, "Member 'UTabGameOptionsMain_C::Language' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, MouseScopedMultiplier) == 0x000300, "Member 'UTabGameOptionsMain_C::MouseScopedMultiplier' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, MouseSensitivity) == 0x000308, "Member 'UTabGameOptionsMain_C::MouseSensitivity' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, MouseTargetingMultiplier) == 0x000310, "Member 'UTabGameOptionsMain_C::MouseTargetingMultiplier' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, Region) == 0x000318, "Member 'UTabGameOptionsMain_C::Region' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, SafeZone) == 0x000320, "Member 'UTabGameOptionsMain_C::SafeZone' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, ShowBackpack) == 0x000328, "Member 'UTabGameOptionsMain_C::ShowBackpack' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, ShowHeadAccessories) == 0x000330, "Member 'UTabGameOptionsMain_C::ShowHeadAccessories' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, SprintCancelsReload) == 0x000338, "Member 'UTabGameOptionsMain_C::SprintCancelsReload' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, TapInteract) == 0x000340, "Member 'UTabGameOptionsMain_C::TapInteract' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, ToggleSprint) == 0x000348, "Member 'UTabGameOptionsMain_C::ToggleSprint' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, ToggleTargeting) == 0x000350, "Member 'UTabGameOptionsMain_C::ToggleTargeting' has a wrong offset!");
static_assert(offsetof(UTabGameOptionsMain_C, TooltipDisplayReference) == 0x000358, "Member 'UTabGameOptionsMain_C::TooltipDisplayReference' has a wrong offset!");
