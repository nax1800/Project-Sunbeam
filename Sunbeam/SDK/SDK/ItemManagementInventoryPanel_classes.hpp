...
public:
	...
	class UHorizontalBox*                         UpgradeResourcesBox;                               // 0x03C8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UItemManagementInventoryPanel_C) == 0x0003D8, "Wrong size on UItemManagementInventoryPanel_C");
...
static_assert(offsetof(UItemManagementInventoryPanel_C, UpgradeResourcesBox) == 0x0003C8, "Member 'UItemManagementInventoryPanel_C::UpgradeResourcesBox' has a wrong offset!");
static_assert(offsetof(UItemManagementInventoryPanel_C, bUseRetire) == 0x0003D0, "Member 'UItemManagementInventoryPanel_C::bUseRetire' has a wrong offset!");
static_assert(offsetof(UItemManagementInventoryPanel_C, bHideCount) == 0x0003D1, "Member 'UItemManagementInventoryPanel_C::bHideCount' has a wrong offset!");
static_assert(offsetof(UItemManagementInventoryPanel_C, bHideResources) == 0x0003D2, "Member 'UItemManagementInventoryPanel_C::bHideResources' has a wrong offset!");
static_assert(offsetof(UItemManagementInventoryPanel_C, bHideTitle) == 0x0003D3, "Member 'UItemManagementInventoryPanel_C::bHideTitle' has a wrong offset!");
