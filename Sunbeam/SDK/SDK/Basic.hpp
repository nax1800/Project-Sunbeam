...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0678E010;
	constexpr int32 AppendString      = 0x01337530;
	constexpr int32 GNames            = 0x06785448;
	constexpr int32 GWorld            = 0x068799F0;
	constexpr int32 ProcessEvent      = 0x01427390;
	constexpr int32 ProcessEventIdx   = 0x0000003E;

	constexpr int32 SetWorld = 0x022b18f0;
	constexpr int32 InitListen = 0x07594b3b;
}
