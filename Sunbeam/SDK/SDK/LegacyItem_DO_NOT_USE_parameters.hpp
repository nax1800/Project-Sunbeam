...
public:
	...
	EItemDisplayStyle                             K2Node_Select_Default;                             // 0x0045(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(LegacyItem_DO_NOT_USE_C_Get_Display_Style) == 0x000046, "Wrong size on LegacyItem_DO_NOT_USE_C_Get_Display_Style");
...
static_assert(offsetof(LegacyItem_DO_NOT_USE_C_Get_Display_Style, K2Node_Select_Default) == 0x000045, "Member 'LegacyItem_DO_NOT_USE_C_Get_Display_Style::K2Node_Select_Default' has a wrong offset!");
