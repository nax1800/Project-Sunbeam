...
static_assert(sizeof(XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts) == 0x000058, "Wrong size on XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts");
...
static_assert(offsetof(XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts, K2Node_CustomEvent_BoostAmount) == 0x000054, "Member 'XpBoostCounts_C_ExecuteUbergraph_XpBoostCounts::K2Node_CustomEvent_BoostAmount' has a wrong offset!");
...
static_assert(sizeof(XpBoostCounts_C_HandleAccountUpdate) == 0x000024, "Wrong size on XpBoostCounts_C_HandleAccountUpdate");
