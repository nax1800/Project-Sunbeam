...
static_assert(sizeof(DailyQuestWidget_C_SetQuestItem) == 0x000058, "Wrong size on DailyQuestWidget_C_SetQuestItem");
...
static_assert(offsetof(DailyQuestWidget_C_SetQuestItem, CallFunc_GetRewardInfo_BP_ReturnValue) == 0x000010, "Member 'DailyQuestWidget_C_SetQuestItem::CallFunc_GetRewardInfo_BP_ReturnValue' has a wrong offset!");
static_assert(offsetof(DailyQuestWidget_C_SetQuestItem, CallFunc_GetDisplayName_ReturnValue) == 0x000040, "Member 'DailyQuestWidget_C_SetQuestItem::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
